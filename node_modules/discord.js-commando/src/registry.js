...
class CommandRegistry {
	 ...
	 * @param {boolean} [options.ping=false] - Whether or not to register the built-in ping command
	 ...
	 * @return {CommandRegistry}
	 */
	registerDefaultCommands({ help = true, prefix = true, ping = false, eval_ = true, commandState = true } = {}) {
